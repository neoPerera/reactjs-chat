...
class NewsFeed extends Component {
    ...
    render() {
            ...
            <div>
                ...
                <div className="header">
                    ...
                    <div className="header__right">
                        ...
                        <img
                            ...
                            alt=""
                        />
                        <h4>{this.state.myCookie.UserName}</h4>
                        </div>
                ...
                <div className="main__body">
                    <div className="sidebar">
                        ...
                        <div className="sidebarRow" eventKey="logOut"   onClick={this.logOutSelected}>
                        <span className="material-icons"> expand_more </span>
                        <h4>Log out</h4>
                        </div>
                    </div>
                    <div className="feed overflow-auto"  >
        ...
        {/* 
                    ...
                    <div style={{flex: 0.33}} className="widgets position-sticky">
                        <div
                        className="fb-page"
